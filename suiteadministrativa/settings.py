"""
Django settings for suiteadministrativa project.
...
SECRET_KEY = 'django-insecure-yc2qcz!m5$)7fuftp0wnm)4w@y5p(@x40s-lcc74epn-8l3*v3'
...
ROOT_URLCONF = 'suiteadministrativa.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'C:/Users/SistemasGSV/Desktop/suiteadmin/tasks/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'suiteadministrativa.wsgi.application'
